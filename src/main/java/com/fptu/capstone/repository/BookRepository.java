...
public interface BookRepository extends JpaRepository<Book, Integer> {
    ...
    @Query(value = "select top(10) book_id, status_id, book_name, overall_rating, total_rating, updated_date, description, like_count, enabled,started_date, alias_id, creator_id, image_link from Book order by started_date desc", nativeQuery = true)
    ...
    List<Book> findBookByContainName(@Param("searchword") String searchword);
